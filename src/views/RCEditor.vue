  ...
  <div class="rc-editor">
    <a-layout style="padding: 32px 24px 20px; overflow: hidden; height: 100%;">
      ...
      >
        ...
        <div class="rc-editor-wrapper">
          <div class="side-block">
            <span class="input-label">Название вида</span>
            <a-input placeholder="Тут ввести название вида" />
          </div>
          <div
            class="rc-editor-container"
          >
            <svg
            ...
            >
              ...
              <image
                width="100%"
                height="100%"
                xlink:href="../assets/rc-editor.png"
                :style="{ opacity }"
              />
            </svg>
          </div>
...
export default {
  ...
  mounted() {
    ...
    const editorArea = document.querySelector('.rc-editor-container');
